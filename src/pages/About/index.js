        ...
        <SubPage pageTitle = "تعرف علينا" className = { header_background } />
            <div className = { `${ about } --container` } >
                <div className = { context } style={{textAlign: "right"}}>
                    <p>
                        شركة برستيج جلاس بي اي هى شركة تقدم خدمات الزجاج, افضل جودة للزجاج بمواصفات عالمية
                        لمواكبة الطلب على الزجاج السكوريت وجميع أنواع الزجاج
                        مع فريق مبيعات متخصص ومحترف للمساعدة في جميع الاستفسارات
                        <br /><br />
                         
                        برستيج جلاس بي اي تقدم حلولًا كاملة لجميع مجالات الزجاج السكوريت المصنفر و الشفاف. بعد اعوام من الخبرة في توريد و تركيب الزجاج ، تنتشر
